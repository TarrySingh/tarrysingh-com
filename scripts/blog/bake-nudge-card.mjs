 ...
 *   STUDIO_AI_MODEL=claude-sonnet-4-5         (optional)
...
const MODEL = process.env.STUDIO_AI_MODEL || "claude-sonnet-4-5" // 4-6 has no access on the studio key; 4-5 is confirmed working
