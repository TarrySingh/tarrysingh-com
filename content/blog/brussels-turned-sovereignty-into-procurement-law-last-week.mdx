...
Three things happened in the last week of May that, taken together, mark the moment digital sovereignty stopped being a conference slide and became something a board has to budget for.
...
Let me take them in order, because the sequence is the story.
...
The Investment Screening Bureau advised State Secretary Willemijn Aerdts to proceed with a complete prohibition of the acquisition, and she adopted the advice.
 ...
 The €100 million deal had already cleared the competition regulator in February. The national-security screen reached the opposite conclusion, and the mechanism behind it was an American law — 

the 2018 CLOUD Act, which gives US law enforcement and intelligence agencies authority to compel US-headquartered companies to hand over data stored on their servers anywhere in the world, regardless of the host country's data protection laws.
...
AWS, Azure and Google Cloud together control roughly 70 percent of Europe's cloud market, and Europe does not yet have homegrown hyperscalers capable of absorbing the full range of government workloads currently on American infrastructure.
...
Here's where it gets uncomfortable. In April the Commission ran a pilot of its own medicine — a €180 million sovereign cloud tender — and the result exposed the gap between the rhetoric and the market. 
...
Francisco Mingorance, secretary general of the European cloud trade association CISPE, called recognising S3NS as sovereign "clearly an own goal" that "threatens to institutionalize sovereignty washing at the highest levels."
 ...
 The Commission's defence was that 

non-European technologies, when operated within a strict and appropriate framework, can meet the minimum level of sovereignty required.
...
The independent capability picture is brutal for Europe. On SemiAnalysis's ClusterMAX ranking from April 2026, 

the EU member-state category contains exactly one Gold-tier provider — Nebius, the Dutch successor to Yandex — one Silver-tier provider in France (Scaleway), one in Luxembourg (GCORE), and all remaining providers in the "Not Recommended" category.
...
And the timing is not on Europe's side. The Cloud and AI Development Act, the legislative heart of the package, 

is scheduled for Q4 2027

 while the underlying inputs — GPUs, power, qualified operators — stay globally constrained.

## the contradiction in the EU's own week

Watch what Brussels did either side of the sovereignty push. On 7 May the co-legislators agreed to *soften* the AI Act. 
...
So in a single month the Union eased its flagship AI rulebook under external pressure and hardened its cloud-sovereignty stance against the same external party. That isn't strategy. That's two directorates pulling against each other while the lobbying weather decides which one wins on any given Tuesday.

Meanwhile the compute story everyone is supposedly sovereign-proofing against keeps shifting under everyone's feet. 

The US Commerce Department approved around ten Chinese companies including Alibaba, Tencent and ByteDance to buy Nvidia H200 chips, under an arrangement where the US would receive 25% of the revenue.

 Export control as revenue share. The chokepoint is being monetised, not defended.
...
But here is my calibrated stake: **I'd bet against any sovereignty strategy that leads with a vendor's "sovereign" label rather than with an architecture.** The S3NS episode is the warning. If the Commission's own flagship tender can be accused of sovereignty-washing, your procurement team's "EU sovereign cloud" tick-box is worth precisely nothing in front of a regulator or a court. 
...
Do the unglamorous work. Inventory which workloads run on which providers under which jurisdiction — most organisations cannot answer that in a single document, and that itself is the first finding. Tier the data. Keep frontier-dependent workloads where the frontier compute actually is, with encryption keys you hold and an exit plan you've tested under failure, not on paper. Treat "sovereign" as a property you can evidence, not a logo you can buy.

The 95 European firms who wrote to von der Leyen demanding a continent-wide sovereign effort weren't wrong about the need. They were early about the supply. Until the capacity catches the rhetoric — and that is a three-year build at best — sovereignty in Europe will mostly be a story enterprises tell themselves about workloads still physically running on someone else's silicon.
