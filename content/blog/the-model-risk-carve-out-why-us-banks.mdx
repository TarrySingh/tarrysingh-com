...
Non-compliance penalties reach up to €35 million or 7 per cent of worldwide turnover. That is not a slap on the wrist; that is an extinction-level event for a midsize insurer or payments processor.
...
The core concern: these models are getting good enough to find and exploit software vulnerabilities faster than human security teams can patch them. That is not hypothetical. That is observable capability today.

The EBA is urging banks to strengthen three pillars: operational resilience, cybersecurity measures, and contingency planning. What is unstated but obvious is that you cannot have operational resilience for a system you do not inventory, cybersecurity measures for a model you have not validated, or a contingency plan for behaviour you cannot predict. The control environment assumes visibility. Agentic AI, as currently deployed, does not offer visibility by default. It offers *outcomes*—correct or catastrophically wrong.
...
Early deployments have shown the potential to enable zero-touch operations and reduce manual workloads by 30 to 50 per cent. Those are not pilots. Those are production systems making real decisions about real money.

This year, 82 per cent of midsize companies and 95 per cent of private-equity firms have either begun or plan to implement agentic AI in their operations in 2026, per Citizens Bank research. 

Top use cases include cybersecurity, fraud detection, and financial planning and analysis. 

Business Email Compromise, phishing, and data breaches claimed $14.3 billion last year, rising at a 19.6 per cent annualised rate from 2023 to 2025, according to Nasdaq Verafin's 2026 Global Financial Crime Report.
