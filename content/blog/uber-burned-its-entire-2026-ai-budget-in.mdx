...
The reason right-sizing works is that the price difference between tiers is enormous and the capability difference for most tasks is small. As of June 2026, Anthropic's Haiku 4.5 runs $1 input and $5 output per 1 million tokens; Sonnet 4.6 is $3/$15; Opus 4.8 is $5/$25.
