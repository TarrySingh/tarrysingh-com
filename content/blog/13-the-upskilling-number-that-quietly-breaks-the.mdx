...
only 53% are educating their broader workforce to raise AI fluency and 48% are implementing reskilling strategies. Just 33% are redesigning career paths.

Most of that 53% is running awareness courses. A webinar, a prompt-engineering deck, a Slack channel. That is fluency theatre. It moves a slide and leaves the capability where it was. Deloitte's own read is blunt: 
