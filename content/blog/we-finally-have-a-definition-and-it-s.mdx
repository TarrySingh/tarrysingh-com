---
title: "We finally have a definition · it's still half the problem"
date: "2026-07-11"
category: "Essays"
...
The framework answers the *what* while dodging the *why* and ignoring the *who pays*.

68% of teenagers already use AI. Over 60% of Europeans possess basic digital literacy in 2026. But in 2025, ICT specialists made up 5% of the total workforce, half of the 10% target in the EU's own Digital Decade strategy.
...
High-risk requirements for stand-alone high-risk AI systems become applicable on 2 December 2027, a date pushed back by the Digital Omnibus the Council approved on 29 June 2026. But the literacy requirement did not move.
...
I have spent the last year working with engineering faculties on PANORAIMA, the Pan-European Network for Responsible Artificial Intelligence Multisector Masters. It launched on 29–30 January 2025 at HU University of Applied Sciences Utrecht under the DIGITAL-SKILLS-5 call, and brings together 16 organisations (8 universities, 4 research centres and 4 SMEs) to co-design modular curricula and self-standing upskilling and reskilling units aligned to market needs. PANORAIMA builds on HCAIM (Human-Centred AI Master's), which started in 2021 and ended in 2024, with consortium members from five EU countries developing a curriculum in human-centred artificial intelligence.

The 60-credit programme launched as a complementary master's at the Budapest University of Technology and Economics in 2022. About 90 students have joined since inception, and the dropout rate is around 50%, because students have to acquire extra credits that often do not fit into their two-year master's degree. You cannot bolt a responsible-AI module onto an already-compressed master's without paying the ergonomic cost.
...
Learner expectations are set at basic, intermediate and advanced levels so the same competence can be taught across year groups. That is sensible. The unanswered question is *who teaches it when primary-school teacher training budgets are zero and half the secondary teachers using ChatGPT to mark homework have no technical degree?*

## The 2030 cliff edge is in forty-three months

The EU's Digital Decade targets call for 80% of adults to have at least basic digital skills and 20 million employed ICT specialists by 2030, with increased women's participation. At the current pace, the number of ICT specialists will reach just 12 million by 2030.

In 2025, more than 10 million people in the EU worked as ICT specialists, 5% of total employment. Women accounted for only 19.5% of ICT employment in 2024. Doubling the current specialist base in forty-three months, then adding 50% again to reach 20 million, has to happen in an environment where Europe does not produce enough ICT graduates and the labour market is already bottlenecked as a result.

The literacy framework is primary and secondary. It does not credential. It does not guarantee a pipeline.

A draft was opened for consultation in May 2025 and drew feedback from more than 2,000 teachers, education leaders, policymakers, learning designers, researchers and others across over 100 countries. That consultation breadth is admirable. But the Commission knows the mathematics. With AI uptake rising across virtually all key sectors, skills needs now exceed current workforce projections. The European Legal Gateway Office pilot in India, launched in February 2026, recognises that the EU has to go looking for global talent.

The framework development budget would do more good split two ways: half to teacher upskilling at scale, half to removing the friction that caused HCAIM's 50% dropout rate. The framework is a public good. But unless there is a funded path from "Shape AI" in Year 10 to a master's track that does not cost students two extra semesters and €15,000 in forgone wages, we are building a front door with no building.
...
## What the Act requires, and what it leaves out
...
The Commission's answer is 'it depends': on the role of each organisation in the AI value chain, the risk level of the systems used, and the current knowledge of staff. In many cases, asking staff to read an AI system's instructions for use may be ineffective and insufficient.
...
The EU has invested over €288 billion in digital projects, and the Digital Europe Programme has put over €294 million into skilling, upskilling and reskilling initiatives. Yet more than half of EU companies struggle to find employees with the right skills, and vacancies go unfilled. What is missing is a credentialing apparatus that universities, EdTechs, employers and Member State qualification authorities recognise at the point of decision. Another framework will not supply it.

PANORAIMA is testing this at master's level. The project develops specialised tracks in Healthcare & Life Sciences, Media & Culture, Law & Compliance, and Management & Finance, alongside self-standing modules for reskilling and upskilling the existing workforce. First pilot runs of the specialisation tracks start in September 2026, with full availability including online modules from September 2027. If the dropout rate mirrors HCAIM, half of those who begin will not finish. Two years plus friction is too expensive a price signal.

## Where the next euro should go

Fund teacher AI literacy at ten times current scale. Make it technical literacy: enough that a geography teacher can open the black box on an adaptive-assessment system and understand whether the loss function penalises working-class postcodes.

Remove the ECTS penalty for students adding AI modules to existing programmes. Make the credit substitutive, so the calendar does not grow. HCAIM lost half its cohort to calendar Tetris, and PANORAIMA will lose the same unless the incentive changes.
...
Accept that Norway may be right. Run a controlled trial: 200 primary schools, half with full generative-AI access, half with restriction, measure reading outcomes over twenty-four months. If the erosion hypothesis holds, we save a generation. If it does not, we have the data to defend deployment.

The 18 June framework is well constructed. It will be translated, downloaded, discussed. None of that closes the 9.7-million-person gap by 2030. That requires money, faculty time, curriculum substitution, and the political courage to treat skilling as critical infrastructure rather than a conference output. I have defended numbers in front of boards for thirty years, and these do not add up yet.
