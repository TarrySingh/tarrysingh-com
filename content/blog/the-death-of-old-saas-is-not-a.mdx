...
In August 2025, CEO Marc Benioff revealed the company had cut 4,000 customer support roles, bluntly stating it needed fewer employees as it deployed AI agents to handle support tasks.
 ...
 ([FinalRoundAI](https://www.finalroundai.com/blog/salesforce-layoffs-2026)) The irony is thick: Salesforce confirmed approximately 1,000 further positions were eliminated, even as it celebrated record-breaking growth and massive adoption of its Agentforce platform. It restructured the very teams that built those tools.
