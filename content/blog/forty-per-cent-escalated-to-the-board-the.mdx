...
date: "2026-08-02"
category: "Essays"
excerpt: "Sixty-two per cent of organisations say an unexpected AI cost materially altered a business decision this year, and 40 per cent had to take it to the board. A charge only reaches directors once it has cleared the spending authority of whoever caused it. Budgets set in 2025, before agentic workloads ran at production scale, are now carrying orphaned agents that burn tokens with no owner and no attributed business outcome."
draft: false
