...
Anthropic's [Economic Index for March 2026](https://www.anthropic.com/research/economic-index-march-2026-report), built from roughly a million conversations across Claude.ai and the developer API, reports that about 49% of jobs already have at least 25% of their tasks performed through Claude. On the consumer side, augmentation has crept back ahead of automation, 52% against 45%. On the enterprise API side, automation dominates at 75%. Both numbers are interesting; neither is evidence of skill growth in the humans nearby. They measure what the model did. Not one of them touches what the person learned.
