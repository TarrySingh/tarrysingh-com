...
A system you could once hold in a single head (read end to end, reason about over an afternoon) became, across the software-eats-everything decades, an artefact whose internal complexity outran any individual's comprehension by something on the order of four orders of magnitude. The exact figure is almost beside the point. What matters is the shape of the two curves. Complexity climbs, on a log scale, roughly exponentially. Human comprehension is the amount one person can actually hold in mind, and it grows, at best, linearly. Plot them together and you do not get a lag that the next tool closes. You get a wedge that opens wider every year. Software entropy is not a metaphor borrowed from physics for color. It is the lived condition of every codebase old enough to have outlived the people who wrote it.
...
- [**The interactive proposal →**](/synaptic/symphony) · the SYMPHONY microsite: the planispheric substrate, the four neuromodulatory scales side by side, and the consortium with primary-source citations.
- [**The Set Piece: The Comprehension Gap →**](/blog/the-comprehension-gap) · the scroll-driven feature this essay expands, scene by scene.
- [**The full dossier →**](/dossiers/Symphony-Additional-Information-Dossier.docx) · the EIC Pathfinder *Additional Information* document, in print form.
- [**MEMPHIS →**](/synaptic/memphis) · the separate hardware-substrate project the closing nods to.

Adjacent dispatches on the sovereignty thread: [Three flags, one substrate](/blog/three-flags-one-substrate) and [Brussels turned sovereignty into procurement law](/blog/brussels-turned-sovereignty-into-procurement-law-last-week).
