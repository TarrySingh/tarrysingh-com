...
Workers completed tasks 25.1% faster with 40%+ higher quality ratings in Harvard Business School studies, programmers produced 126% more coding output per week according to Nielsen Norman Group, and developers completed tasks 55% faster using GitHub Copilot in research involving 4,800 developers. The divergence is not subtle: individual contributors report extraordinary gains, finance reports flat productivity.
...
GitHub Copilot now generates 46% of code written by developers and Microsoft CEO Satya Nadella confirmed that Copilot now represents a larger business than GitHub itself at the time of the 2018 acquisition. That revenue milestone is important—it tells you the product has commercial traction—but it does not tell you whether the *buyers* are measuring cycle time, defect rates, or just seat utilisation. My bet: most are measuring seats.
...
Only 21% of workers use AI daily despite 91% of organisations claiming to use it; 56% of workers received no AI training; and 73.8% of workplace ChatGPT accounts are personal unsecured accounts. That last figure is the governance time bomb. Measure it, then eliminate it.
...
Gartner forecasts 40% of enterprise applications will embed task-specific agents by end-2026, up from under 5% in 2025, while over 40% of agentic AI projects are forecast to be cancelled by 2027. Both predictions can be true. Embedding is cheap—wrap an LLM call in a workflow trigger and call it an agent. Graduating from pilot to production requires measurement discipline that most enterprises do not have, so the cancellation rate will be high.

If I were allocating capital in this cycle, I would bet against vendors selling 'time saved' as a proxy for ROI, and I would bet on the 13 per cent of organisations that have built the workflow redesign and quality controls required to convert task-speed into margin. That 13 per cent— the organisations getting real business value from AI despite 87% of workers using it and 11 hours saved per week
