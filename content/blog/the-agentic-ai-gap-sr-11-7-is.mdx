...
In the UK: the Financial Policy Committee has asked the Bank of England and FCA to undertake further work on agentic AI, focused on use cases in payments and financial markets.

 Further work, then. No rules yet.

Into this three-jurisdiction gap, vendors are shipping. 

Gartner predicts that 40% of financial services firms will use AI agents by 2026, though it warns that more than 40% of projects across industries could fail by 2027 due to cost pressures and unclear benefits.

 I doubt the 40% adoption number holds. The pilots are real; the production deployments are fewer. Even at half that penetration, a fifth of the industry is running autonomous decision-support systems under no framework designed for them.
...
Only 26.4% of financial institutions express confidence in their AI compliance readiness according to the Wolters Kluwer Q1 2026 Survey.
