...
Bundle the regime as a tuple $b = (\mathcal{S}_b, \Gamma_b, V_b, L_b)$, meaning schema, generators, a **verifier**, and an optional description-length functional. The full live state then becomes a single object the paper calls a knowledge-computation graph:
