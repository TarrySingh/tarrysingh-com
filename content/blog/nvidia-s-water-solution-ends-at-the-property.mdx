...
A 2026 analysis by Xylem and Global Water Intelligence found that direct data centre cooling accounts for only 4% of the additional water AI will demand by 2050; power generation accounts for roughly 54%, and semiconductor fabrication the remaining 42%. Nvidia's closed-loop design addresses one-twentieth of the problem. Vendor marketing implies something closer to three-quarters.
...
flowchart LR
  ...
  B --> E[Warm-water closed loop, about 4% of added water demand]
  C --> F[Gas and coal plants ramping for firm supply]
  F --> G[Evaporative cooling at the power plant, about 54%]
  D --> H[Fab water use, about 42%]
...
The IEA's April 2026 update confirms the demand trajectory is steeper than the efficiency offset. Global electricity demand from data centres grew 17% in 2025, in line with IEA projections, while electricity consumption from AI-focused data centres surged 50%. Global electricity consumption for data centres is projected to nearly double to reach around 945 TWh by 2030, representing just under 3% of total global electricity consumption. That's a contained share in global terms, but the regional concentration creates acute stress. US data centre electricity consumption is expected to increase by around 240 TWh (up 130%) by 2030; China by around 175 TWh (up 170%).

The policy misstep is treating this as a cooling-technology problem when it is a grid-sequencing and power-source problem. Closed-loop liquid cooling buys down direct water use, provided you can afford the retrofit capital and are building at sufficient density. It does nothing about the 54% of AI's water footprint that sits behind the meter, in the gas combined-cycle plants and coal stations that ramp when the wind dies. Natural gas and coal are expected to provide more than 40% of new electricity needed to meet data centre demand through 2030, per the IEA. The cooling loop is closed; the fuel loop is not.
