...
Broadcom's Jericho 4 already targets secure, lossless fabrics for clusters above one million XPUs; the open path exists. It just demands deliberate procurement discipline that prizes optical-layer interoperability over the path of least resistance.
