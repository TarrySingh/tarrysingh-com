...
date: "2026-06-05"
category: "Essays"
excerpt: "Inside thirteen days Brussels told teachers to adopt AI, delayed the rules governing the riskiest classroom uses, and only then began explaining what those rules mean. It isn't a plan — it's three workstreams that never reconciled their calendars."
draft: false
tags: ["eu-ai-act", "ai-in-education", "high-risk-classification", "ai-literacy", "credentialing"]
---

Three things happened in Brussels inside thirteen days in May. Taken one at a time, each reads like routine EU process. Taken together, they describe a policy that is arguing with itself in public — and leaving every dean, rector and VET coordinator in Europe to referee.

Here is the sequence, in absolute dates because relative ones obscure the point.
...
So inside a fortnight: encourage teachers to adopt AI, delay the rules that govern the riskiest educational uses by sixteen months, and — finally, late — start explaining what those rules even mean. I've sat through enough programme reviews to recognise the shape of this. It isn't a plan. It's three workstreams that never reconciled their calendars.

## the guidance was late, and that is the story

Don't let the delay headline distract you. The more telling fact is that the high-risk classification guidance was statutorily overdue.
...
Education sits in the same tier as credit scoring and law-enforcement tooling. That is not an accident of drafting — it reflects how much a grade can determine a life.

The draft itself reads the exceptions tightly.
...
A generative model marking an essay is not organising the record. It is shaping the judgment. So is most of what teachers were just encouraged to explore.

## the trap teachers were walked into

Here's where it gets uncomfortable. The European University Association's Michael Jørgensen put the problem more bluntly than any regulator has dared.
...
Now layer on the ambition. OpenAI's EU Economic Blueprint proposes — and the Commission's own skills agenda echoes — a headline number.
...
([Visual Capitalist](https://www.visualcapitalist.com/cp/europe-2030-digital-skills-target/)) If we cannot get to basic digital competence, a hundred million people fluent in prompt engineering and model limitations is a target written for a press release, not a budget line.

And here is the credentialing gap that the literacy talk skates over. The Commission's own answer to "who trains the trainers and what is the certificate worth" is still being assembled.
...
([European Commission](https://digital-strategy.ec.europa.eu/en/policies/ai-talent-skills-and-literacy)) An academy that aggregates courses is not a credential a labour market trusts. A credential needs an awarding body, a standard, and recognition across borders — the same recognition problem that has dogged the digital-skills certificate for years.

This is the part of the file I work on most directly, through the HCAIM and PANORAIMA programmes, and I'll say plainly what the slide decks won't: literacy without assessable, portable credentials is consumption, not capability. You can teach 100 million people to chat with a model. Certifying that any of them can govern one is a different, harder, slower thing.

## what I'd push if I was asked for advice 😅
...
([European Education Area](https://education.ec.europa.eu/focus-topics/digital-education/actions/plan/ethical-guidelines-for-educators-on-using-artificial-intelligence)) Read it. But guidance is not cover.

If I sat on a university or VET board this quarter, I would not wait for December 2027. I'd push for three things, fast. First: a hard line that no consumer LLM touches summative assessment until classification is documented — the delay is runway to build governance, not an excuse to do nothing. Second: a written inventory of every place AI already shapes a judgment about a learner — admissions screening, progress monitoring, grading — because those are the Annex III triggers, and most institutions cannot currently produce that list. Third: treat the credentialing question as a procurement decision, not a marketing one — demand that any "AI literacy" programme issues an assessable, recognised qualification, or decline it.

The contrarian bet: Europe will hit neither the 80% basic-skills target nor the 100-million figure by 2030, and the binding constraint won't be compute or curriculum. It will be that we mandated adoption and deferred the rules that make adoption safe — and asked teachers to stand in the gap. That's a mistake. Teachers are guides, not crash-test dummies for an unfinished regulation.
