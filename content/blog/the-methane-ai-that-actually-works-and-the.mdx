...
the response rate to MARS alerts has increased to more than 12 per cent, which means 88 per cent of alerts still go unaddressed. That figure is up from only 1 per cent in 2024, so the trend is defensible—but it means the constraint is no longer the algorithm.
