...
%%{init:{"theme":"base","themeVariables":{"primaryColor":"#E8EEF4","primaryBorderColor":"#5B9BD5","primaryTextColor":"#003366","lineColor":"#5B9BD5","fontFamily":"Segoe UI, Helvetica Neue, Arial, sans-serif","fontSize":"13px","edgeLabelBackground":"#FFFFFF"}}}%%
flowchart LR
  subgraph BROKEN[" "]
    direction TB
    B_H["BROKEN EDGE"]
  ...
  classDef headerRed fill:#B71C1C,stroke:#B71C1C,color:#FFFFFF,font-weight:bold,font-size:15px
  classDef headerAmber fill:#E65100,stroke:#E65100,color:#FFFFFF,font-weight:bold,font-size:15px
  classDef headerOrange fill:#F57F17,stroke:#F57F17,color:#FFFFFF,font-weight:bold,font-size:15px
  classDef descNode fill:#FFF8E1,stroke:#F57F17,stroke-width:1px,color:#003366,font-size:12px
  classDef deptNode fill:#E8EEF4,stroke:#5B9BD5,stroke-width:2px,color:#003366,font-size:13px
  classDef failNode fill:#FFEBEE,stroke:#B71C1C,stroke-width:2px,color:#B71C1C,font-size:12px,font-weight:bold
  classDef takeawayHeader fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:14px
  classDef takeawayNode fill:#FFFFFF,stroke:#5B9BD5,stroke-width:1.5px,color:#003366,font-size:13px,font-weight:bold

  class B_H headerRed
  class I_H headerAmber
  class IC_H headerOrange
  class B_DESC,I_DESC,IC_DESC descNode
  class B1,B2,I1,I2,IC1,IC2 deptNode
  class B3,I3,IC3 failNode
  class T_H takeawayHeader
  class T1,T2 takeawayNode

  style BROKEN fill:#FFEBEE,stroke:#B71C1C,stroke-width:2px,rx:8
  style IGNORED fill:#FFF3E0,stroke:#E65100,stroke-width:2px,rx:8
  style INCOMPLETE fill:#FFF8E1,stroke:#F57F17,stroke-width:2px,rx:8
  style TAKEAWAY fill:#E8EEF4,stroke:#003366,stroke-width:2px,rx:8
```
...
flowchart TD
  ...
  classDef titleNode fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:16px
  classDef statNode fill:#FFEBEE,stroke:#B71C1C,stroke-width:1.5px,color:#B71C1C,font-size:13px,font-weight:bold
  classDef deptHeader fill:#5B9BD5,stroke:#5B9BD5,color:#FFFFFF,font-weight:bold,font-size:13px
  classDef toolNode fill:#FFFFFF,stroke:#BDBDBD,stroke-width:1px,color:#616161,font-size:11px
  classDef transformHeader fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:15px
  classDef stepNode fill:#E8EEF4,stroke:#5B9BD5,stroke-width:2px,color:#003366,font-size:13px,font-weight:bold
  classDef afterTitle fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:16px
  classDef coreHeader fill:#1B5E20,stroke:#1B5E20,color:#FFFFFF,font-weight:bold,font-size:13px
  classDef coreNode fill:#E8F5E9,stroke:#2E7D32,stroke-width:1.5px,color:#1B5E20,font-size:13px
  classDef resultHeader fill:#1B5E20,stroke:#1B5E20,color:#FFFFFF,font-weight:bold,font-size:14px
  classDef resultNode fill:#E8F5E9,stroke:#2E7D32,stroke-width:1.5px,color:#1B5E20,font-size:13px,font-weight:bold

  class BEF_H titleNode
  class BEF_STAT statNode
  class BM_H,BS_H deptHeader
  class BM1,BM2,BM3,BM4,BM5,BM6,BM7,BM8,BM9,BS1,BS2,BS3,BS4,BS5,BS6,BS7,BS8,BS9,BS9 toolNode
  class TR_H transformHeader
  class TR1,TR2,TR3,TR4 stepNode
  class AFT_H afterTitle
  class AC_H coreHeader
  class AC1,AC2,AC3 coreNode
  class AR_H resultHeader
  class AR1,AR2,AR3,AR4 resultNode

  style BEFORE fill:#FFF3E0,stroke:#E65100,stroke-width:2px,rx:8
  style BF_MKT fill:#FFEBEE,stroke:#BDBDBD,stroke-width:1px,rx:6
  style BF_SALES fill:#FFEBEE,stroke:#BDBDBD,stroke-width:1px,rx:6
  style TRANSFORM fill:#E8EEF4,stroke:#003366,stroke-width:2px,rx:8
  style AFTER fill:#E8F5E9,stroke:#1B5E20,stroke-width:2px,rx:8
  style AF_CORE fill:#C8E6C9,stroke:#2E7D32,stroke-width:1.5px,rx:6
  style AF_RESULT fill:#C8E6C9,stroke:#2E7D32,stroke-width:1.5px,rx:6
```
...
flowchart TD
  ...
  classDef titleNode fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:17px
  classDef phaseHeader fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:14px
  classDef actionNode fill:#FFFFFF,stroke:#5B9BD5,stroke-width:1.5px,color:#003366,font-size:12px
  classDef portcoNode fill:#E8EEF4,stroke:#5B9BD5,stroke-width:2px,color:#003366,font-size:12px,font-weight:bold
  classDef compoundHeader fill:#1B5E20,stroke:#1B5E20,color:#FFFFFF,font-weight:bold,font-size:15px
  classDef compoundStat fill:#E8F5E9,stroke:#2E7D32,stroke-width:1.5px,color:#1B5E20,font-size:13px,font-weight:bold
  classDef mathHeader fill:#003366,stroke:#003366,color:#FFFFFF,font-weight:bold,font-size:14px
  classDef mathNode fill:#FFF8E1,stroke:#F57F17,stroke-width:1.5px,color:#003366,font-size:13px
  classDef mathBig fill:#F57F17,stroke:#F57F17,color:#FFFFFF,font-weight:bold,font-size:15px

  class SP_H titleNode
  class ACQ_H,AUD_H,OPT_H,EX_H phaseHeader
  class A1,A2,A3,AU1,AU2,AU3,O1,O2,O3,E1,E2,E3 actionNode
  class PF1,PF2,PF3,PF4 portcoNode
  class CP_H compoundHeader
  class CP_STAT compoundStat
  class MA_H mathHeader
  class MA1,MA2,MA3 mathNode
  class MA4 mathBig

  style SPONSOR fill:#F0F4F8,stroke:#5B9BD5,stroke-width:2px,rx:8
  style ACQUIRE fill:#E8EEF4,stroke:#5B9BD5,stroke-width:1.5px,rx:6
  style AUDIT fill:#E8EEF4,stroke:#5B9BD5,stroke-width:1.5px,rx:6
  style OPTIMISE fill:#E8EEF4,stroke:#5B9BD5,stroke-width:1.5px,rx:6
  style EXIT fill:#E8EEF4,stroke:#5B9BD5,stroke-width:1.5px,rx:6
  style COMPOUND fill:#E8F5E9,stroke:#1B5E20,stroke-width:2px,rx:8
  style PORTFOLIO fill:#C8E6C9,stroke:#2E7D32,stroke-width:1.5px,rx:6
  style MATH fill:#FFF8E1,stroke:#F57F17,stroke-width:2px,rx:8
```
