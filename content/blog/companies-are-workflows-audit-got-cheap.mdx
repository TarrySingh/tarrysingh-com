...
flowchart LR
  ...
  IGNORED ~~~ INCOMPLETE
  INCOMPLETE --> TAKEAWAY
  classDef hdrRose fill:#cf7d5a,stroke:#cf7d5a,color:#0c1828,font-weight:bold
  classDef hdrCopper fill:#c98e4f,stroke:#c98e4f,color:#0c1828,font-weight:bold
  classDef hdrCool fill:#849cc8,stroke:#849cc8,color:#0c1828,font-weight:bold
  classDef hdrViolet fill:#a698d4,stroke:#a698d4,color:#0c1828,font-weight:bold
  classDef descNode stroke:#849cc8,stroke-width:1px
  classDef deptNode stroke:#c98e4f,stroke-width:1.5px
  classDef failNode stroke:#cf7d5a,stroke-width:1.5px,font-weight:bold
  classDef takeawayNode stroke:#a698d4,stroke-width:1.5px,font-weight:bold
  class B_H hdrRose
  class I_H hdrCopper
  class IC_H hdrCool
...
flowchart TD
  ...
  classDef hdrCopper fill:#c98e4f,stroke:#c98e4f,color:#0c1828,font-weight:bold
  classDef hdrCool fill:#849cc8,stroke:#849cc8,color:#0c1828,font-weight:bold
  classDef hdrTeal fill:#5fa6b4,stroke:#5fa6b4,color:#0c1828,font-weight:bold
  classDef statNode stroke:#cf7d5a,stroke-width:1.5px,font-weight:bold
  classDef toolNode stroke:#849cc8,stroke-width:1px
  classDef stepNode stroke:#c98e4f,stroke-width:1.5px,font-weight:bold
  classDef goodNode stroke:#5fa6b4,stroke-width:1.5px
  class BEF_H hdrRose
...
flowchart TD
  ...
  classDef hdrCopper fill:#c98e4f,stroke:#c98e4f,color:#0c1828,font-weight:bold
  classDef hdrTeal fill:#5fa6b4,stroke:#5fa6b4,color:#0c1828,font-weight:bold
  classDef actionNode stroke:#849cc8,stroke-width:1.5px
  classDef portcoNode stroke:#a698d4,stroke-width:1.5px,font-weight:bold
  classDef statNode stroke:#5fa6b4,stroke-width:1.5px,font-weight:bold
  classDef mathNode stroke:#c98e4f,stroke-width:1.5px
