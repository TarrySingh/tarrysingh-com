...
Zylo's [2025 SaaS Management Index](https://zylo.com/news/2025-saas-management-index) tracked enterprise software portfolios and found the average organisation was burning $21 million a year on unused or under-utilised licences, a 14% year-over-year rise in waste, with 52.7% of provisioned seats sitting idle. Productiv's three-year study of about 100 million enterprise seats put the unused share at 40%. Gartner's last public sales-tech read pegged the figure more conservatively at 25% unused, and added that **40% of seller productivity is lost to context-switching** between the CRM and the half-dozen point tools that ship around it.
