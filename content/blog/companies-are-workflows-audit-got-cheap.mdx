...
```mermaid
%% caption: Before: 60-200 tools per department, half the seats idle. After: a unified data layer and an agent that orchestrates the workflows that remain.
flowchart TD
  subgraph BEFORE[" "]
    direction TB
...
Zylo, Productiv and Gartner have each measured the waste.

| Source | Finding |
| - | - |
| Zylo's [2025 SaaS Management Index](https://zylo.com/news/2025-saas-management-index) | Tracked enterprise software portfolios and found the average organisation was burning $21 million a year on unused or under-utilised licences, a 14% year-over-year rise in waste, with 52.7% of provisioned seats sitting idle |
| Productiv's three-year study of about 100 million enterprise seats | Put the unused share at 40% |
| Gartner's last public sales-tech read | Pegged the figure more conservatively at 25% unused, and added that **40% of seller productivity is lost to context-switching** between the CRM and the half-dozen point tools that ship around it |
...
Take a mid-sized enterprise at $1 billion to $5 billion in revenue, the size of company that is too large to know its own systems and too small to have anyone whose job it is to find out. Its marketing organisation will be running somewhere between 60 and 100 vendors across inbound, outbound, brand, content, analytics, and partner functions.

| Tool | Vendors or count |
| - | - |
| Customer-data platform | Segment, mParticle, Tealium, or whatever the chosen Adobe or Salesforce suite ships natively |
| Marketing-automation suite | Marketo, HubSpot, Pardot, depending on what got bought when |
| Attribution tool | Usually Bizible or Demandbase |
| CMS | Plus four separate content products |
| ABM platform | |
| SEO suite | |
| Social listening | Three tools because the agencies each brought one |
| Analytics | Four dashboards |
| Influencer system | Standalone, because somebody read a deck |
...
We could not have built what an agent layer can build today. The lesson stuck, though: the bottleneck was never the absence of data, it was the absence of plumbing. The vendor sprawl was a symptom; the disease was that no subsystem could speak across the others. A marketing organisation with 100 vendors and three real workflows is the same organisation as one with five vendors and three real workflows. It is just more expensive, slower, and harder to audit.

### The day-after-tomorrow target

The reasonable target for that company today, with the tooling that did not exist then, is a marketing function running on a unified data layer, three to five core systems of record, and an agent layer that orchestrates the workflows the operators actually run. The vendor count drops thirty to 50%. The headcount does not, but the headcount stops being a coping mechanism for tools that do not integrate and starts being a creative function again.
...
### Eighty to 200 tools across the funnel
...
Agentic AI does not abolish vendors. It abolishes the per-edge labour cost.

| Source | Finding |
| - | - |
| McKinsey's [most recent agentic-AI economic read](https://www.mckinsey.com/capabilities/quantumblack/our-insights/seizing-the-agentic-ai-advantage) | Puts the global productivity uplift at $2.6 to $4.4 trillion annually |
| McKinsey's [November 2025 State of AI](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) | Found 62% of organisations were experimenting with or scaling agents and 23% had a production agent in at least one function |
| Deloitte's 2026 enterprise survey | Put the average measured ROI on agentic deployments at 171% and the US figure at 192% |

The global productivity uplift is a number that should be discounted on instinct, but I'll note that across twenty years of these forecasts McKinsey's enterprise-software productivity figures have consistently been *under* the eventual measured value, not over. These are not vendor brochures. These are the response patterns from CIOs and CFOs whose careers are on the line when the number is wrong.
...
Run the numbers, conservatively. Take the 33,000 actively held operating companies. Assume a median revenue in the $150 million to $300 million band, a defensible middle for the held book once you exclude the megacap exceptions on either end. That is a global revenue footprint somewhere between $5 trillion and $10 trillion under PE ownership. 1 percentage point of operating-margin uplift across that base is **$50-100 billion a year of recoverable EBITDA**, money the sponsor either captures at exit through a higher multiple or leaves on the table for the next owner to harvest.
