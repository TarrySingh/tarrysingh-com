...
Run the numbers, conservatively. Take the 33,000 actively held operating companies. Assume a median revenue in the $150 million to $300 million band, a defensible middle for the held book once you exclude the megacap exceptions on either end. That is a global revenue footprint somewhere between five and $10 trillion under PE ownership. One percentage point of operating-margin uplift across that base is **$50-100 billion a year of recoverable EBITDA**, money the sponsor either captures at exit through a higher multiple or leaves on the table for the next owner to harvest.
