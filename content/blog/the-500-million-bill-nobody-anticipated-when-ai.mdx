...
That is the canary. When enterprises reprioritize CapEx *away* from transactional workloads to secure AI infrastructure supply, then discover they cannot afford to run what they just bought, something breaks. The companies that locked in $700 billion in hyperscale buildout commitments — with capital expenditures reaching $650 billion in 2026 and surpassing $1.1 trillion in 2027
 ...
 — are betting that enterprises will absorb the inference cost. But the FinOps Foundation locates 80 to 90 percent of AI expenditures in inference, not in training, yet GPU utilization during operation often ranges from 15 to 30 percent.
