...
date: "2026-06-09"
category: "Essays"
excerpt: "We argue about Europe versus the rest of the world. The real divergence is inside Europe — a converging East and a stalling West — and the country-by-country map of who is rising and who is falling is almost the exact opposite of the one in your head."
draft: false
tags: ["Europe", "economics", "convergence", "sovereign AI", "strategic autonomy", "geopolitics"]
---

Every few months a chart goes around that tells you Europe is finished. Four lines, three decades, a story so clean it barely needs a caption: the United States holds the line, China rockets up, and Europe slides from a quarter of the world economy to a fifteenth. The former Italian prime minister Giorgia Meloni put the European half of it plainly — in 1990 the then-twelve-member club was about 26 percent of world GDP; today the twenty-seven-member Union is around 16 percent, while the US is still near 26. The bloc got bigger and its slice got smaller. People share the chart with a little funeral emoji and move on.

I build agentic AI systems for a living, in Europe, and I can't switch off the habit of checking a number before I believe it. So I went and pulled the actual figures behind the "Europe versus the world" story. The trend is real. The slice really has shrunk. But the chart commits a quieter, more interesting error than getting a decimal wrong. It treats "Europe" as a single economy — one line, one trajectory, one fate.

It isn't one economy. But before I take the average apart, look at the picture everyone's actually fighting about.

## First, the scoreboard everyone argues about

Here's the global board — Europe's share of world output against the United States, China, and everyone else, across three decades. Drag the toggle.

<GdpShareChart />

That toggle is the whole trick, and most people sharing the viral chart don't know it's there. Measure every economy at **market exchange rates** — the nominal view — and the US is the clear number one near 26 percent, China sits *below* the European Union, and its slice peaked back in 2021. Switch to **purchasing power parity**, which adjusts for the fact that a haircut or a bowl of noodles costs a fraction as much in Chengdu as in Munich, and the order inverts: China becomes the world's largest economy, the US and EU below it. Same year, same countries, opposite headline. Nobody is lying. They're holding different rulers.

That one choice settles arguments people don't know they're having. Take China's rise, the thing everyone treats as a one-way escalator:

<ChinaPeakChart />

At market rates it didn't keep climbing — it topped out near 18.5 percent in 2021 and has slipped since, on a weaker yuan, a property hangover and stretches of outright deflation. The relentless-rise story is a purchasing-power story. In the currency the world actually trades in, China already peaked. Both true; different rulers.

<RankFlipChart />

There's the entire argument in one frame: the same three economies, ranked one way by market value and the opposite way by real output. The honest answer to "who's the biggest economy" is a question — biggest at *what*?

And Europe? On the measure that actually tracks how well people live — real output per person, each economy in its own constant prices — Europe has been quietly slipping behind the United States for two decades:

<PerCapitaChart />

The two lines tracked together until 2008, then the US pulled away while the euro area double-dipped through 2011–2013. Today American real output per head is up about 38 percent since 2000; the EU's, about 24. A real gap, pointing the wrong way — though nowhere near the "Europe is half of America" headlines you'll see, which are nominal market-FX comparisons flattered by a strong dollar and a weak euro. The honest version is a moderate, persistent lag, not a collapse.

So that's the scoreboard: Europe smaller than it was, behind the US, above or below China depending on which ruler you pick up. It's all true, and it's all beside the point — because every one of those charts makes the same mistake. It treats "Europe" as a single line. And Europe isn't one economy. It's at least two, moving in opposite directions, and when you average them into one falling line you destroy the most important fact on the continent.
...
And the West — the comfortable core — has a third problem, the one Mario Draghi's competitiveness report was honest enough to name. Strip out information and communications technology and European productivity roughly matched the United States across 2000–2019. Europe didn't fall behind at everything. It fell behind at the one thing that compounds: digital technology. Four of the world's top fifty tech firms are European — four, not forty. Around 70 percent of the world's foundational AI models have been built in the US since 2017. The core didn't collapse; it missed the single most important industry of the era, and it's now paying the interest.

The clearest single picture of that miss is the long arc of European productivity against the American benchmark:

<ProductivityChart />

Europe spent the post-war decades closing the gap — output per hour climbing from under half the US level in 1960 to about 95 percent by the mid-1990s. Near parity. And then, right as the digital era began, it stalled and slid back below 80 percent. Read that shape carefully, because it's the engine under every GDP number in this essay. A continent that closes a fifty-year gap and then reopens a fifth of it in thirty isn't having a bad year. It's having a bad era — and the era is defined by exactly the technology it didn't build.

## The catch in the catch-up

Before I get triumphant about the East, the same discipline that made me suspicious of the funeral-chart makes me suspicious of the boom. There are two catches in the catch-up, and an honest map has to show both.
...
The eastern boom was built on being the best place to run *someone else's* industrial process. The next decade's growth will be built on cognition — agentic AI, the compute under it, the energy under that — and there the whole continent, East and West alike, is currently a customer rather than an owner. Three American hyperscalers serve the majority of Europe's own cloud. The models the economy is starting to run on are trained and governed elsewhere. Convergence that stops at "good place to deploy foreign AI" is convergence with a built-in ceiling. The opening is to build the sovereign, auditable, governable stack here — and the hungriest place to build it is the half of Europe that already knows how to catch up.
</Callout>
