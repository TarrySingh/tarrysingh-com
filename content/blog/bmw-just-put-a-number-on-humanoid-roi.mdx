---
title: "BMW just put a number on humanoid ROI · the rest of manufacturing is watching"
date: "2026-07-26"
category: "Essays"
excerpt: "BMW's ten-month, 30,000-unit deployment of Figure AI's humanoid at Plant Spartanburg has shifted the industry's central question from 'can it work?' to 'at what cost, and where?' With unit costs projected below $17,000 by 2030 and current ROI timelines compressing toward 14 months, humanoid robots are becoming a capital-allocation decision. The binding constraint has moved from hardware to integration."
draft: false
tags: ["humanoid-robots", "manufacturing-ai", "industrial-automation", "physical-ai", "automotive", "enterprise-ai"]
---
On 25 June 2026, BMW announced that Figure AI's Figure 03 humanoid robot will begin logistics sequencing work at Plant Spartanburg, a month after the automaker confirmed it had already run the predecessor, Figure 02, through production of more than 30,000 BMW X3 vehicles over ten months. Ten months on the line is a shift pattern.
...
That work is repetitive, speed-dependent and precise. 
...
Figure 03 adds tactile-sensor hands, palm cameras, wireless charging, and speech-to-speech audio over its predecessor. The wireless charging removes one more tether, one more source of downtime, one more maintenance intervention. 
...
```mermaid
%% caption: BMW's two-site humanoid deployment mirrors how automotive programmes move from prototype to series production. Spartanburg develops the playbook, Leipzig tests it under different labour, regulatory and supply-chain constraints.
flowchart LR
...
BMW established a Center of Competence for Physical AI in Production and is expanding humanoid deployments to Plant Leipzig in Germany starting summer 2026. That organisational move, creating a dedicated centre, puts humanoids into the production-systems playbook. A skunkworks reporting into advanced manufacturing does not get its own centre.
...
That is a six-fold increase in seven years. 

Mercedes-Benz signed a commercial agreement with Apptronik in 2024, and Mercedes invested a low double-digit million amount in Apptronik in March 2025 at its Digital Factory Campus in Berlin. The OEMs are building the business case in their own plants, without waiting for a standards body to certify anything.
...
The companies that win this cycle will be the ones that solve the integration problem. A photogenic demo will not decide it. BMW has given the rest of the industry a production benchmark, a cost envelope, and a twelve-month timeline. The hard part is not building the robot. The hard part is making it boring enough to run on second shift without a PhD babysitter.

A Tier 1 supplier or a mid-market discrete manufacturer should have a pilot running by Q4 2026. The argument is about the learning curve, and it has nothing to do with humanoids replacing a workforce. In two years the competitors who started will have eighteen months of that curve behind them, and the board will want to know why ergonomic problems are still being solved with overtime.
