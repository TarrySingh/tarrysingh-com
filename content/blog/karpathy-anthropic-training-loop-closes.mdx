...
date: "2026-05-21"
category: "Essays"
excerpt: "Karpathy's first assignment at Anthropic is to point the current model at the job of building the next one. The research cycle is being compressed from the inside — and the question worth holding any lab accountable on is whether anyone is still paid to stand outside the loop and grade what comes out."
draft: false
