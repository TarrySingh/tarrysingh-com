...
Hedge funds entered Q2 2026 with a record 10% portfolio weight in Semiconductors, while their 6% weight in Software marks the lowest since 2019.
...
The most popular long positions within Info Tech have returned 62% year-to-date, according to Goldman. That is a number vendors will quote and realists should interrogate.
...
The typical hedge fund now holds 72% of its long portfolio in its top 10 positions.

72%. That is a concentrated bet with a compliance wrapper around it.

## Where the tension lives

Short interest for the median S&P 500 stock has risen to 3% of market cap, the highest level since 2011.
...
Software & Services as an industry group is down 14% year-to-date. Semiconductors & Semi Equipment are up 38% YTD and have surged 104% in the past year.
...
Meanwhile, Uber's COO Andrew Macdonald recently admitted on the *Rapid Response* podcast that the firm can't draw a clear line between rising Claude Code usage and consumer-facing innovation, after burning through its entire 2026 AI coding-tools budget in just four months.
...
The 4.9% ETF share of hedge fund long portfolios represents the highest level since the GFC.
