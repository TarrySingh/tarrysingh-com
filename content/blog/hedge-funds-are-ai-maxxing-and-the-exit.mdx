---
title: "Hedge Funds Are AI'maxxing — and the Exit Door Is Getting Narrower"
date: "2026-05-28"
category: "Essays"
...
The report — covering 1,059 hedge funds with $4.6 trillion in gross equity positions — shows that funds lifted their net tilt to the Information Technology sector by +853 basis points, the largest quarterly increase to the sector on record.

 That is not a rotation. That is a stampede.
...
Hedge funds entered Q2 2026 with a record 10 per cent portfolio weight in Semiconductors, while their 6 per cent weight in Software marks the lowest since 2019.
 ...
 Let that ratio sit for a moment. Two-to-one, hardware over software, at a time when the actual enterprise consumption story is deeply ambiguous.
...
The largest increases occurred in Semiconductors (+428 bp), Systems Software (+167 bp), Tech Hardware (+147 bp), and Application Software (+133 bp).
 ...
 Those sub-sector moves tell you exactly where fund managers believe AI value accrues: silicon, not the application layer.
...
The most popular long positions within Info Tech have returned 62 per cent year-to-date

, according to Goldman. That is a number vendors will quote and realists should interrogate.
...
Seventy-two per cent. That is not a diversified book. That is a concentrated bet with a compliance wrapper around it.

## Where the tension lives

Here is the bit that should make allocators sweat. 

Short interest for the median S&P 500 stock has risen to 3 per cent of market cap, the highest level since 2011.

 And 

gross leverage ranks in the 94th percentile versus the last five years.
...
```mermaid
%% caption: The self-reinforcing loop that turns an AI-infrastructure conviction into a crowding risk — each step feeds the next until the exit reverses the engine.
flowchart LR
...
Software & Services as an industry group is down 14 per cent year-to-date, while Semiconductors & Semi Equipment are up 38 per cent YTD and have surged 104 per cent in the past year.

 

Roughly $2 trillion in software market cap has been wiped out over the past twelve months

 in what Jefferies traders labelled the "SaaSpocalypse."
...
The cause is a fundamental reassessment of where AI value actually accrues — and the answer, increasingly, is not in the application layer.

 But I'd bet against that consensus hardening into permanence. Somebody has to monetise inference at the point of business process. The picks-and-shovels thesis works until the gold rush slows.
...
The 4.9 per cent ETF share of hedge fund long portfolios represents the highest level since the GFC.
 ...
 Hedge funds — the people paid 2-and-20 to pick stocks — are buying S&P 500 index funds at a rate last seen in 2008. You don't need me to explain what that implies about their actual stock-picking confidence outside the mega-cap tech basket.

## What I'd tell a board right now

If I were sitting on an allocation committee, three questions would dominate.

**One: how correlated is your manager roster?** If your five "diversified" hedge fund allocations are all long Nvidia, AMAT, LRCX, and short software, you don't have five managers. You have one trade with five fee layers.

**Two: what happens to AI capex when the demand side disappoints?** 
...
**Three: who owns the short book pain?** 

U.S. equity hedge funds have returned 7 per cent year-to-date through 21 May

, which sounds decent until you realise the S&P 500 is roughly flat and the Mag-7 are carrying the index. The longs are working. The shorts are bleeding. That's survivable right up until it isn't — and "right up until it isn't" is a phrase I associate with late-cycle positioning.
...
I'd bet against the current semiconductor weighting surviving the next serious vol event intact. Not because the AI build-out is fake — it isn't — but because 1,059 funds simultaneously deciding the same sub-sector is the only trade worth owning is the textbook definition of a crowded exit in formation.
