...
date: "2026-06-02"
category: "Essays"
excerpt: "A trillion dollars of compute spend is the most concrete thing in technology right now. The return it is meant to justify is the most fictional. The capex is real; the NPV is a guess dressed as a forecast."
draft: false
...
Google, Amazon, Microsoft, and Meta collectively plan to spend $725 billion on capex in 2026, up 77% from last year's record $410 billion, according to first-quarter earnings compiled by the Financial Times.
 ...
 Add Oracle, the neoclouds, Chinese hyperscalers and the sovereign funds, and the cycle clears a trillion dollars of compute spend in a single calendar year.
...
## the tell came from a buyer, not a short-seller

On 22 May 2026, Uber's president and COO Andrew Macdonald sat on a podcast and said the quiet thing. 

He said it's hard to draw a connection between the company's rising use of Claude Code and innovations meant to serve consumers — "that link is not there yet," he said.

 This is a man whose engineers are not dabbling. 

Claude Code went from 32% of Uber engineers in February to 84% classified as agentic users by March; by spring 95% of engineers were using AI tools monthly, with roughly 70% of committed code originating from them.
...
The quandary in enterprise AI adoption is that increasing AI use comes with higher costs, even as per-unit AI pricing falls.
 ...
 The 2024–25 era of subsidised free tiers is closing. Even Microsoft saw the problem in its own house — 

it reportedly began cancelling most of its direct Claude Code licences, moving engineers toward GitHub Copilot CLI instead.
...
"You can't own anything but AI—that's how a bubble forms," he wrote, expecting limited downside until growth slows or core inflation meaningfully accelerates.

 The bank reached for the mid-1800s railway mania as its analogue — vast sums raised to build networks before over-valued stocks collapsed — and noted 

that Q1 2026 AI capex totalled $174 billion, up 72.8% year on year.
...
CreditSights put 2026 capex-to-sales at 86% for Oracle, 54% for Meta, 47% for Microsoft, 46% for Alphabet, and 25% for Amazon.
...
Here is where the NPV problem turns structural rather than merely uncertain. A meaningful slice of the "demand" propping up these models is the industry buying from itself.
...
He called understating depreciation by extending useful life "one of the more common frauds of the modern era," estimating that from 2026 through 2028 the manoeuvre would understate depreciation by about $176 billion.
...
Alphabet moved compute and network useful lives from three years in 2020 to six by 2023; Microsoft went from three-year assumptions in 2020 to six from 2022 onward.
 ...
 The real question is whether a chip on Nvidia's annual cadence genuinely earns for six years via cascading lower-tier workloads, or whether a wave of write-downs lands in 2027. If Burry is even half right, reported AI earnings — the thing feeding every forward NPV — are flattering by tens of billions a year.
...
a dedicated vehicle acquires the data-centre assets, the hyperscaler holds a minority stake and commits to long-term leases or capacity offtake, which substitutes upfront capex with multi-year operating expenses while keeping most of the debt off its books.
...
Meta, Alphabet, Amazon and Oracle's combined weight in the Bloomberg US Corporate IG index nearly doubled over the year to 1 April 2026, from 2.2% to 4.1%.
 ...
 And the physical world is pushing back: 

electricity shortages, rising costs and local opposition are delaying nearly half of planned AI data centres for 2026.

 Delayed capacity is delayed revenue. The numerator slips right while the denominator is already spent.

## if I were on one of these boards

I would stop pretending the NPV exists in any defensible form and manage the downside instead. Three things.

Disclose customer concentration the way a bank discloses single-name exposure — if a meaningful share of a hyperscaler's AI backlog traces to two pre-profit labs, shareholders deserve that number, not a backlog headline. Second, publish the depreciation sensitivity: what reported operating income looks like at a three-year GPU life versus six. If management believes six, prove it with utilisation data, not assertion. Third, ringfence the off-balance-sheet vehicles in plain English, because the BIS already understands them and your investors should too.

My stake: I would bet against the proposition that 2027 cash flows justify 2026 spend at the multiples currently priced. Not because AI doesn't work — Uber's engineers prove the demand is real. Because a return nobody can yet measure, funded by debt everyone can, against assets that may depreciate twice as fast as the books assume, is not an investment thesis. It is a wager that the music keeps playing. The capex is the most concrete thing in technology right now. The NPV is the most fictional. Size your exposure accordingly.
