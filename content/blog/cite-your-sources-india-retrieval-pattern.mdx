...
The pattern India is installing, if you strip it down, is a machine version of pointing back at the text and waiting. That is the right pattern. But a teacher who cannot tell whether the child understood is not a teacher yet. She is only a very fast search engine with a warm voice, waiting on a stone floor for the third line to be read again.
