...
---
CompTIA released its inaugural AI Skills Tracker on 21 July 2026, surveying more than 1,000 business and technology leaders. The headline reads like every other workforce-readiness report: 

80 per cent of professionals use AI tools multiple times per month, but only 29 per cent say they have a high level of familiarity with AI technologies. Standard-issue skills gap. Further down, the report says where that familiarity is coming from: 
...
IDC projects that over 90 per cent of enterprises will face critical AI skills shortages in 2026, representing an estimated $5.5 trillion in unrealised productivity. 

Kyndryl's 2026 People Readiness Report found that just 23 per cent of organisations consider their workforce fully ready for AI, a six-point drop from 2025, even as 57 per cent report AI is already embedded in core business processes. We are deploying faster than we are training. That delta is where the value evaporates.

A 2026 DataCamp study found that 82 per cent of enterprise leaders say their organisation provides some form of AI training, yet 59 per cent still report an AI skills gap. If most firms claim to be training, yet most still report gaps, the training itself is the problem. 

Only 35 per cent of leaders report having a mature, organisation-wide AI upskilling programme; most training is fragmented, optional, and disconnected from actual job tasks.

The incentive structure explains it. A vendor sells you GitHub Copilot or Microsoft 365 Copilot or Anthropic Claude for Business. You roll it out. You count adoption. You do not count *competent* adoption because competent is expensive to measure. Your L&D team runs a few webinars, records them, posts the link on the intranet. Completion rate: 40 per cent. Skill transfer rate: untracked. The tools ship, the training decays, and six months later you are surprised the ROI is anaemic.
