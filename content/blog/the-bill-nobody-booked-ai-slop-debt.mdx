...
Third, a **named owner** for every agent in production, with explicit authority to kill it. The Kiteworks finding, that 63 percent of organisations cannot stop their own AI, is an org-design problem dressed up as a technology problem.
