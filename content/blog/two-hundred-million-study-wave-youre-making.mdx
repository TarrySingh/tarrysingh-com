---
title: "200 million to Study the Wave You're Making"
date: "2026-06-12"
category: "Essays"
...
[McKinsey's State of AI Trust 2026](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/tech-forward/state-of-ai-trust-in-2026-shifting-to-the-agentic-era), drawn from roughly 500 organizations surveyed late last year, puts regular AI use at 88% of respondent firms. Generative-AI use stands at 72%, up from 33% two years earlier. The same survey reports that only about 6% of organizations qualify as "AI high performers", meaning they attribute more than 5% of EBIT to AI use. In developed markets a vanishing 1% of executives describe their gen-AI rollouts as "mature." Almost everyone is using it. Almost nobody is making the numbers move enough to defend in front of an audit committee.
...
A piece of evidence that does not get cited often enough sits in [ManpowerGroup's Global Talent Barometer 2026](https://www.manpowergroup.com/en/news-releases/news/global-talent-barometer-2026-ai-use-accelerates-as-worker-confidence-falls-and-job-hugging-takes-hold). Regular AI usage among workers jumped 13 percentage points to 45%. In the same period, confidence in using technology fell 18 points, the first overall decline in worker confidence in three years. The drop was sharpest among Baby Boomers (-35) and Gen X (-25). 56% of the global workforce reported receiving no recent training. 43% said they fear automation may replace their job within two years.
...
Three: what is your training spend per AI-using employee, this year, in money? If the answer is meaningfully smaller than your tool license spend, you are running the ManpowerGroup experiment inside your own company. Treat the 56% no-training figure as a forecast for your own audit findings in eighteen months rather than as a global statistic.
