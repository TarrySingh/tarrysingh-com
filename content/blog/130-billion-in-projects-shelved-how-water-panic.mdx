...
The IEA's February 2026 [*Electricity 2026*](https://www.iea.org/reports/electricity-2026/executive-summary) report projects that global electricity demand is forecast to increase at a brisk average annual rate of 3.6% over the 2026–2030 forecast period, supported by rising consumption from industry, electric vehicles, air conditioning and datacentres. AI is front-running that curve. The grid constraint is now well understood; every utility analyst has modelled the load. Water was an afterthought—externality, local concern, 'not my KPI'—until state legislatures turned it into a gating item.
