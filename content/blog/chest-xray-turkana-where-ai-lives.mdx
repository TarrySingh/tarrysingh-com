...
date: "2026-07-15"
category: "Essays"
excerpt: "The WHO-approved chest X-ray AI models running on tablets in Turkana are working. What is not yet settled is where the stack underneath them actually lives: training pipelines, reference datasets, and GPU clusters that remain, for now, in foreign clouds. The sovereignty argument in African clinical AI is not about slowing deployment — it is about writing the compute transition into procurement documents before the current generation of X-ray machines needs replacing."
draft: false
...
If I were sitting across from a district TB officer in Turkana next week, I would not be asking about model accuracy. WHO has settled that argument for chest X-rays. I would be asking three things. What is the data-residency clause in the contract with the CAD vendor. Where does the aggregated national reporting sit, and who can read it. What is the plan, dated and funded, for the archive and compute layers over the next thirty-six months. Those are the three questions on which the story about clinical AI in Africa in 2028 will be decided. The screening is happening. The stack under it is where the sovereignty argument settles, quietly, in procurement documents, one contract at a time.
