...
An AI-enabled chest X-ray taken today in a village in western Kenya returns a result to the clinician holding the tablet in about 90 seconds. What I want to know is where the reading happens between the moment the shutter closes and the moment the score appears.
