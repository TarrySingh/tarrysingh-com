...
If you are a dispatcher in a state load-despatch centre on Monday morning, the piece of this that shows up on your console is a curtailment ticket. The CEA planning document, the Rajya Sabha reply and ICRA's PDF are somebody else's Monday. Somewhere on your feeder, a solar developer's plant is being told to shed 60% of what it can generate for the next four hours, because there is no path for the electrons to reach the load. The AI on your desk has already told you the plant can generate. Your job today is to explain to a plant manager why it cannot.
