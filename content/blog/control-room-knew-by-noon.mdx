...
date: "2026-08-06"
category: "Essays"
excerpt: "India curtailed 8,133 gigawatt-hours of solar power in the second quarter of 2026, roughly 18% of average monthly generation. The forecasting models worked. Transmission infrastructure was not built in time to carry the output. The country's grid AI layer is functioning as designed; the ceiling it optimises below is set by copper, steel, and land-acquisition law."
draft: false
...
flowchart LR
  ...
  CURT --> FLEX["Coal fleet ramps to 25% minimum load"]
```
...
If you are a dispatcher in a state load-despatch centre on Monday morning, the piece of this that shows up on your console is a curtailment ticket. The CEA planning document, the Rajya Sabha reply and ICRA's PDF are somebody else's Monday. Somewhere on your feeder, a solar developer's plant is being told to shed 60% of what it can generate for the next 4 hours, because there is no path for the electrons to reach the load. The AI on your desk has already told you the plant can generate. Your job today is to explain to a plant manager why it cannot.
