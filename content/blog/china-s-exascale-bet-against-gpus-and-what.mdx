...
I would not dismiss this as a stunt. This is China demonstrating — in a forum designed for reproducible measurement — that it can field a full-stack exascale architecture under export controls that prevent access to H100s, B200s, and InfiniBand. The technical story is in the interconnect.
...
A four-layer fat tree delivers a single-hop latency across the network of 1.07 microseconds, andthe entire bisection bandwidth exceeds 3.5 Pb/s.
...
The entire LineShine system draws 42.22 MW with an efficiency of 52.07 FP64 GFlops/W. That is not competitive with GPU-based inference at FP8, but for sustained double-precision workloads — computational fluid dynamics, climate, molecular dynamics, finite-element — it is in line with Aurora and El Capitan, both of which lean on accelerators and draw comparable or higher power per delivered flop on classical HPC codes.
...
The system incorporates 3D floating orthogonal computing and full liquid cooling to manage thermal output, employing what officials described as the world's largest-scale centralised liquid cooling technology. Liquid cooling is not optional at this density — it is architectural.
...
The global AI datacentre liquid cooling market is entering a high-growth phase, valued at an estimated USD 3.20 billion in 2025, projected to reach USD 3.70 billion in 2026 and expand significantly to USD 17.83 billion by 2036, registering a CAGR of 16.9%.
