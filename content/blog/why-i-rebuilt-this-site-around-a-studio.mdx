...
A studio **is not finished.** A plate on the wall might be a sketch, a printer's proof, or a final piece, and the visitor can usually tell which is which. The room does not pretend everything is shipped. It shows what is in progress, and it shows what has been quietly retired.

It **has a voice.** When you walk into a real working room, you can feel the hand of the person who arranged it. The fonts they chose. The way the books are stacked. Which pencils are sharpened and which are not. A studio is opinionated in a way a CV cannot be.

And it **invites a slow look.** A CV asks you to scan. A studio asks you to stay. You linger over one plate because something in it is unresolved and you want to figure out what.

Those three properties became my brief. Unfinished, opinionated, slow.

## What I chose to keep

I kept the navigation deliberately spare (`/`, `/about`, `/experiments`, `/synaptic`) because every studio I have ever loved has three or four doors rather than twelve.
...
I dropped the dark-mode toggle. The studio has one light setting: afternoon, cream paper, slight grain. The work was made under it.
...
I have written hundreds of thousands of words in the last fifteen years (on LinkedIn, in client decks, in proposals, in private notebooks), and almost none of it lives here. That is a discipline problem. The tooling was never the obstacle.

So the experiment from here is this: every plate I draw, every proposal I send, every conversation that reshapes how I think about a problem gets a short note here. Not a paper. Not a pitch. A note.
