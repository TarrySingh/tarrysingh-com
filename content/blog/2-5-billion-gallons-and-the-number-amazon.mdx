...
211 billion gallons of indirect draw, against direct cooling water in the low tens of billions. The water that matters most is the water nobody puts in the press release.
...
40% of a town's water for one company's servers. That is the kind of local fact no aggregate global number will ever surface.

And the "water positive" replenishment math has its own soft spots.

Google reports that it replenished 64% of its freshwater consumption in 2024, up from 18% the year before. And 28% of total withdrawals occurred in regions with medium or high water stress, exacerbating local vulnerability even as Google celebrates replenishment programmes.
