...
Within the next twelve to eighteen months the equity market will probably reprice the AI-infrastructure cohort sharply, on a single quarter where two things happen at once. A hyperscaler will revise GPU useful lives downward and disclose an unexpected non-cash charge; and a major neocloud will need to refinance into a less generous credit market. Either one alone would pass. Together they will move the names ten to 20% inside a fortnight. It will look, at the time, like a confidence shock. It will actually be a duration-mismatch shock that the credit and accounting plumbing finally surfaced. A repricing on that scale is survivable, and I am not forecasting a crash. The build-out continues afterwards. It just continues from a more honest level.
