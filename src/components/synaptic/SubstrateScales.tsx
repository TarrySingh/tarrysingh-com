...
const SCALES: ReadonlyArray<{ key: ScaleKey; label: string; sub: string; symbol: string }> = [
...
const CELLS: Record<LayerKey, Record<ScaleKey, { title: string; body: string }>> = {
  rationale: {
    ...
    <figure className="syn-symphony">
      ...
      >
        <svg
          ...
          role="img"
          aria-label="Substrate × scales matrix — four code-system layers (rationale, historical, behavioural, structural) crossed with four neuromodulatory scales (hyperparameter, plasticity, neuronal, dendritic). Sixteen cells, sixteen behaviours."
        >
          <defs>
