...
export function ChokepointChapterEleven() {
  return (
    <section id="chapter-11">
      ...
      <Prose>
        <Lead>
          Everything you have read so far is the <em>before</em>. Ten chapters of gaps (capital,
          companies, talent, energy, scale, the quarter-trillion tribute) measured in a world that
          ...
          and it compounds the loss. Software 3.0 is the foot going down on the pedal, and the car
        ...
        <P>
          ...
          model for a few cents today: a fall of around <Won>1,000&times; in three years</Won> at
      ...
      <Prose>
        <P>
          And an exploding prize is won by whoever can pay to serve it, which turns the whole game
          ...
          <Sq>$725 billion</Sq> on AI and data-centre capital expenditure, up about 77% in a single
          ...
          a <Sq>canyon: roughly twelve to one</Sq>, and widening. Europe&rsquo;s flagship answers
          ...
          <Won>Mistral</Won> (France&rsquo;s genuine frontier lab, valued at perhaps $23 billion in
      ...
      <Prose>
        <P>
          ...
          be absent from the defining technology of the age not as a consumer (Europe consumes AI
          voraciously, mostly American AI) but as a <em>producer</em>. And it matters precisely
        ...
        <P>
          ...
          scale; Europe is fragmented. It rewards capital; Europe exports its capital. It
          rewards cheap energy; Europe&rsquo;s power costs double. It rewards data and frontier
          compute; Europe has little of either. Every single input that AI turns into compounding
          advantage is an input this essay has already shown Europe lacks. So the technology does not open
          a new front in the competition; it takes every existing gap (the capital drain, the
          brain-drain, the energy premium, the scale deficit) and runs a multiplier over it. Pull
      ...
      <Prose>
        <PullQuote>
          ...
          a rising tide. It is a current, and it runs toward scale, capital and cheap power, away
        ...
        <P>
          ...
          turn on. A multiplier applied to a deficit widens it, but a multiplier is also the only
          ...
          race for reasons that are, every one of them, choices. And a technology that multiplies
        ...
        <P>
          ...
          Europe&rsquo;s enterprise-software champions (<Sq>SAP</Sq>, the German giant, and the
          per-seat business model it exemplifies) sell software by the user, by the month. But when a
          ...
          mind: a single US hyperscaler&rsquo;s annual capital budget now exceeds the entire yearly
        ...
        <P>
          ...
          twenty-seven-country, much-debated programme. They are not the same kind of number, and
        ...
        <P>
          ...
          frontier models grew ruinously expensive, a parallel world of <Sq>open-weight</Sq> models (freely
          downloadable, cheap to run, good enough for most tasks) exploded to capture roughly{" "}
          ...
          Alibaba&rsquo;s Qwen, and from American challengers like Meta&rsquo;s Llama. And even the
        ...
        <P>
          ...
          the last (tens, then hundreds of millions of dollars, soon billions), and the set of
          ...
          <em>use</em> and ruinously expensive to <em>make</em>. And Europe, with all its savings,
        ...
        <P>
          ...
          fastest public supercomputers (Germany&rsquo;s exascale <Sq>Jupiter</Sq> among them),
          ...
          can build enough, fast enough, to matter; and on current trajectories the honest answer is
          not yet.
        </P>
        ...
        <P>
          ...
          many megawatts you can point at a data centre for months on end, and on that axis
        ...
        <P>
          ...
          standards of the firms they mean to answer, tiny: tens of millions of euros against
        ...
        <P>
          ...
          consume more than <Sq>a thousand terawatt-hours</Sq> of electricity in 2026 (about as much
          as the whole of Japan), and the curve bends sharply upward from there. Satya Nadella,
          ...
          list of decisions, to make its energy among the dearest in the developed world, which means
        ...
        <P>
          ...
          and on the order of <Sq>half a million Nvidia GPUs</Sq>: one company, one site, commanding
          ...
          and thousands of chips, a creditable startup against an industrial juggernaut. The gap is
          not that Europe lacks AI ambition. It is that its largest ambition is roughly the size of an
          American afterthought.
        </P>

        <P>
          And even Europe&rsquo;s answer is built on borrowed silicon. Mistral&rsquo;s own buildout (a{" "}
          <Sq>&euro;1.2 billion</Sq> data-centre programme spanning a live Paris site and a Swedish facility
          for 2027, on the order of <Sq>13,800 Nvidia GPUs</Sq>) runs, like roughly <Sq>four-fifths</Sq> of all
          ...
          inside its own remedy: a sovereign cloud sovereign in everything except the one component
          that matters most.
        </P>

        <P>
          The cruelest statistic in the whole essay may be this one. Europe has more monthly users of
          large-language-model chatbots than the United States does (some <Sq>133 million</Sq>,
          roughly twice the American base), and almost every model they use was built in America.
          ...
          rendered in a single behaviour: a market that adopts the technology avidly, pays for it
        ...
        <P>
          ...
          anything, further behind. The race to build <Sq>humanoid robots</Sq>, general-purpose
          machines that could transform manufacturing and logistics, is being run by America&rsquo;s
          ...
          reshape medicine came out of a London lab (owned, as ever, by Google). Whichever way the
          technology turns next, from chatbots to robots to drug discovery, Europe keeps arriving as the
          customer, the test site, or the acquired (almost never the owner).
        </P>
        ...
        <P>
          ...
          <em>do</em> (not resolve, not report, but do) to take the key it is holding and
          change the lock?
        </P>
      </Prose>
