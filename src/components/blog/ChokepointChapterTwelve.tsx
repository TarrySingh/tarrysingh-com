    ...
    <section id="chapter-12">
      ...
      <Prose>
        <Lead>
          ...
          it holds the one card no one else can replace, and keeps it in its pocket. This chapter is
        ...
        <P>
          ...
          <Sq>100% monopoly</Sq> on extreme-ultraviolet lithography, the machines without which no
      ...
      <Prose>
        <P>
          So if the assets are real, the obvious question is what to <em>do</em> with them, and
          ...
          sitting in low-yield deposits (and the roughly <Sq>&euro;300 billion a year</Sq> that
          currently leaks abroad) could fund European companies instead of American ones. Complete
          ...
          roadmap has even put a deadline on it: December 2027. Back the frontier through InvestAI&rsquo;s{" "}
          <Sq>&euro;200 billion</Sq> mobilisation and its five planned AI gigafactories. Fix the grid and
          the power price. Buy and build European. Pull the levers below, and then look at the gauge
          that matters.
        </P>
      </Prose>
      ...
      <Prose>
        <P>
          ...
          medicine, and the prescription sits un-filled on the counter, because filling it requires
        ...
        <P>
          And yet (and this is why the chapter is not a eulogy) something has changed in the
      ...
      <Prose>
        <P>
          ...
          that the slow economic version of the threat, the bloodless capture documented in every
          chapter, never moved Europe at all; only the sharp, frightening version did. The open
      ...
      <Prose>
        <P>
          ...
          deposits earning next to nothing: not invested, not at risk, not building anything, simply
      ...
      <Prose>
        <P>
          ...
          actually win. <Sq>Edge inference</Sq> (running AI cheaply on local, low-power chips rather
          than in vast foreign data centres) plays to European strengths in semiconductors and
          ...
          <Sq>&euro;33 trillion</Sq> in European savings (through a pension-allocation rule, a public
          guarantee, a Savings and Investments Union with actual teeth) and the missing growth
      ...
      <Prose>
        <P>
          ...
          noticed; it is that every fix requires <Sq>twenty-seven governments</Sq> (each with its own
          banks to protect, its own champions to favour, its own electorate to answer to) to
          ...
          collectively catastrophic to keep blocking. That is the true lock on the door, not American
          power but European collective inaction, and it is the one no foreign capital can pick for
      ...
      <Prose>
        <P>
          ...
          <Sq>&ldquo;EU Inc&rdquo;</Sq>, a proposed pan-European legal entity (a single, optional
          ...
          and it is exactly the kind of fix that matters, because the chokepoint was never built by
      ...
      <Prose>
        <P>
          ...
          several will fail. But the seedbed is not empty (it is, if anything, unusually rich),
      ...
      <Prose>
        <P>
          ...
          the next decade answers is whether it takes a catastrophe to turn it on, or whether, just
      ...
      <Prose>
        <P>
          ...
          something you <em>build</em> (with state money, at national scale, over decades, accepting
          the failures along the way) and then let the market run with. Europe has the savings to fund
      ...
      <Prose>
        <P>
          ...
          whole continent (immune to any one nation&rsquo;s politics), or it will keep being
      ...
      <Prose>
        <P>
          ...
          entirely on execution: on whether twenty-seven governments fund it, sustain it across
      ...
      <Prose>
        <P>
          ...
          consortium (French, German, Spanish and British) backed by patient state money against
      ...
      <Prose>
        <P>
          ...
          positioning accurate to twenty centimetres, <em>better</em> than the American GPS it was
          ...
          not, or need not, do, and did, by pooling sovereignty and spending public money with patience
      ...
      <Prose>
        <P>
          ...
          people, has produced some <Sq>forty unicorns</Sq>, the highest count per head in Europe, with
      ...
      <Prose>
        <P>
          And the next races have not yet been lost; they are being run right now, and Europe is
          ...
          launch startups (Isar Aerospace, Rocket Factory Augsburg) are reaching for orbit. The
      ...
      <Prose>
        <P>
          ...
          matter most (tax, foreign policy, the deepest fiscal integration), a single member
          ...
          concessions. The treaties even contain a mechanism to escape this trap, the
          &ldquo;passerelle&rdquo; clause, but invoking it <em>itself requires unanimity</em>, and it
      ...
      <Prose>
        <P>
          ...
          un-free those things currently are: a discovery made in one member state, a researcher
      ...
      <Prose>
        <P>
          ...
          changed hands before, from Venice to the Dutch Republic to imperial Britain, and the
          ...
          one. And which it becomes is still, narrowly, a matter of choice rather than fate.
        </P>
      </Prose>
      ...
      <Prose>
        <P>
          ...
          transitions, a figure that would once have been unthinkable and is now merely daunting. It
          ...
          decline and reversing it, and the whole argument of this essay is that the second course is
      ...
      <Prose>
        <P>
          ...
          chapters the failure turned out to have names, dates, and line items: every one of them a
        ...
        <P>
          ...
          <Sq>below a tenth by 2050</Sq>: a continent shrinking from a pole of the world economy into
          ...
          as well, and Europe keeps, politely, declining to take it.
        </P>
        ...
        <P>
          ...
          that the continent risks becoming an <Sq>open-air museum</Sq>: a beautiful, beloved place to
          ...
          <em>default</em>: the thing that happens if nothing is decided.
        </P>
        ...
        <P>
          ...
          sequence of shocks (tariffs aimed explicitly at its tech rules, a pause in intelligence to
          Ukraine, sanctions that knocked a war-crimes prosecutor off his email, open talk of taking
          Greenland by force) that the dependence catalogued in these pages was not a comfortable
          ...
          measured. And the things that are finally <em>felt</em> are sometimes, at last, the things
          that get done.
        </P>
        ...
        <P>
          ...
          it has been out-<em>nerved</em>. It holds ASML, the savings, the market, the science: the
          ...
          turned. And the key, the one no one else on Earth can cut, has been European all along. The
