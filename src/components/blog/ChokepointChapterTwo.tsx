    ...
    <section id="chapter-2">
      ...
      <Prose>
        <Lead>
          ...
          ignoring it. The document was Mario Draghi&rsquo;s report on European competitiveness:
        ...
        <P>
          ...
          additional <Sq>&euro;750&ndash;800 billion of investment every year</Sq>: on the order of{" "}
          ...
          which, given that Europe is the richest savings bloc on the planet, ought to have been
        ...
        <P>
          ...
          Draghi measured is not closing while you read about it; it is opening, on every axis that
      ...
      <Prose>
        <P>
          ...
          the venture capital the United States does; the American market runs <Lev>four to five
          ...
          <Sq>&euro;10.6 billion</Sq>, a ratio in the region of <Won>fifty-five to sixty to
        ...
        <P>
          ...
          recommendations finds that only about <Sq>15% are fully binding law</Sq>. And that figure
          ...
          already closing. Whole domains (energy, defence, pharmaceuticals, the automotive sector)
          register essentially <Sq>zero</Sq> structural progress. Scrub the timeline below and
      ...
      <Prose>
        ...
        <P>
          ...
          relaunched, rebranded, and re-committed to roughly once per Commission ever since, most
      ...
      <Prose>
        <P>
          ...
          tech communiqué is <Won>&ldquo;sovereignty&rdquo;</Won>: digital sovereignty,
        ...
        <PullQuote>
          ...
          losing: the difference between a patient who never saw the doctor and one who read the
        ...
        <P>
          ...
          thing about it is how much of the required capital already exists inside Europe; it is a
        ...
        <P>
          ...
          curdled into what one analysis called a &ldquo;paper monster&rdquo;: years of working
        ...
        <P>
          ...
          more than <Sq>ten thousand Blackwell GPUs</Sq> (a billion-euro build that lifted German AI
          ...
          dependency keeps reappearing one layer down (the chips are Nvidia&rsquo;s, the reference
          designs American), and &ldquo;sovereign&rdquo; increasingly means a European-run building
        ...
        <P>
          ...
          learned to answer Europe&rsquo;s sovereignty worries by building on European soil: AWS,
          ...
          real story: American AI and data-centre capital expenditure runs into the hundreds of
        ...
        <P>
          ...
          on American clouds has lived in a state of permanent legal provisionality, patched by
          ...
          the dependence hardened from a procurement choice into the assumed shape of the world.
        </P>
        ...
        <P>
          ...
          from foreign law, and in April 2026 the European Commission itself awarded a roughly{" "}
          <Sq>&euro;180 million</Sq> sovereign-cloud contract to a slate of European providers (OVHcloud,
          STACKIT, Scaleway, Proximus): the first procurement to apply explicit sovereignty criteria,
          though one winning group leans on the Thales&ndash;Google joint venture S3NS, which critics were
          quick to call &ldquo;sovereignty-washing&rdquo;; a coalition of
        ...
        <P>
          ...
          public body toward sovereign and open-source tools rather than the American defaults (an
          ...
          (the retraining, the integration, the thousand small reasons it is always easier not to)
          is the test that matters, and the one the rest of Europe will be watching.
        </P>
        ...
        <P>
          ...
          the most sensitive European data sit only with providers immune from foreign law, which is
          ...
          by Washington as a happy accident of market share. It is actively defended, because the
        ...
        <P>
          ...
          regions (the same firms that, in mid-2026, faced preliminary findings that their cloud
          ...
          the adjective off the shelf. The noun (actual, unconditional control) is the one
        ...
        <P>
          ...
          in returns between European and American business, almost the entire difference (by one
        ...
        <P>
          ...
          founded from scratch in the last fifty years</Sq>, while the United States has minted six of
        ...
        <P>
          ...
          costed and signed by the establishment&rsquo;s own oracle, then where, precisely, does
