  ...
  return (
    ...
    >
      <svg
        ...
        role="img"
        aria-label="The energy scissors, 2021 to 2030. A falling copper line on a logarithmic left axis shows the cost of a unit of intelligence collapsing from 100% of its 2021 value to about one-thousandth of a percent, roughly a thousandfold cheaper. A rising teal line and bars on a linear right axis show total AI and data-centre electricity climbing from about 230 terawatt-hours to 945 terawatt-hours by 2030, around 3% of global electricity and comparable to Japan's entire consumption. The two curves cross around the mid-2020s: the Jevons paradox, where each unit gets cheaper yet the total burned explodes. An inset tracks frontier training-run power rising from roughly 125 megawatts in 2024 toward 4 to 16 gigawatts by 2030. Historical through 2024, projection thereafter. Sources: the IEA Energy and AI report 2025 and Epoch AI."
