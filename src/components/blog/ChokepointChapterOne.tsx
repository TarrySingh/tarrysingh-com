    ...
    <section>
      ...
      <Prose>
        ...
        <P>
          ...
          power &mdash; the compounding gap between the growth the Netherlands is managing and the growth
      ...
      <Prose>
        ...
        <P>
          ...
          against a 3% target it set itself &mdash; a shortfall the deck puts at roughly{" "}
          ...
          technology, but because it declines to install it &mdash; which, for the nation that builds the
        ...
        <P>
          ...
          population, has minted dozens across its modern history &mdash; the figure the Dutch benchmark
          cites is <Lev>41</Lev> &mdash; and produces them at about <Lev>four times</Lev> the Dutch
          ...
          companies both &mdash; and the deck&rsquo;s own verdict is that they succeeded <em>despite</em>
        ...
        <P>
          ...
          bar chart of attrition; it is a haemorrhage, and it bleeds at one specific wound &mdash; the
      ...
      <Prose>
        <P>
          ...
          incumbents it already knows &mdash; Shell, Unilever, Philips &mdash; over the challengers it
          ...
          venture capital</Sq> &mdash; debt for the safe, subsidies for the rest &mdash; and
        ...
        <P>
          ...
          future &mdash; and it invests almost none of it at home. Dutch pension funds hold only around{" "}
          ...
          The country starves its own scale-ups of late-stage capital &mdash; and then posts the savings
        ...
        <P>
          ...
          actually decide which companies scale &mdash; the &euro;50-million-plus raises &mdash; the share
          ...
          with the cheque &mdash; and the reason no Dutch trustee is ever punished for owning US Treasuries
        ...
        <P>
          ...
          Netherlands is governed on the wrong clock. Strategic industries &mdash; chips, grids, biotech,
          energy &mdash; run on forty-year horizons. Dutch politics runs on four. And every time the
          ...
          to make forty-year bets &mdash; whose future rounds, some <Sq>&euro;6.8 billion</Sq>, were
      ...
      <Prose>
        <P>
          ...
          premium &mdash; the compounding cost of every reset &mdash; is paid by exactly the deep-tech
        ...
        <P>
          ...
          So they go &mdash; the deck&rsquo;s estimate is that <Sq>90% of Dutch AI PhDs leave
          ...
          reverse &mdash; an exporter of the one input it cannot afford to lose.
        </P>
        ...
        <P>
          ...
          maths, reading and science &mdash; a quiet erosion of the very numeracy a high-tech economy runs
          ...
          level</Sq> &mdash; reindustrialisation blocked at the socket. (That grid earns a chapter of its
        ...
        <P>
          ...
          is the soft tissue around all the hard numbers &mdash; the reason a brilliant Delft postdoc
        ...
        <P>
          ...
          on <Won>repay-on-success</Won> terms &mdash; the state carries the downside, takes royalties
          ...
          mentorship into the next cohort. Switzerland leans on pharma-scale corporate R&amp;D &mdash;
          Roche, Novartis &mdash; to top the global innovation index year after year. Denmark binds its
        ...
        <P>
          So this is not a mystery, and it is not a tragedy in the Greek sense &mdash; there is no flaw of
          ...
          themselves, in a deck designed to be read by the people who could change it &mdash; which is
        ...
        <P>
          ...
          the load &mdash; recurs at continental scale, with more zeros on the end. The canary has
