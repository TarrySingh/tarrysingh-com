...
const CATEGORIES: CategoryDef[] = [
  {
    ...
    tasks: [
      ...
      { id: "income_verify", name: "Income & Employment Verification", desc: "Verify borrower income through employer VOE, tax transcripts (4506-T), bank statement analysis. Handle self-employed borrowers with P&L review and business tax return analysis.", aiScore: 82, complexity: 6, frequency: "Daily", tools: ["The Work Number", "Plaid", "Finicity", "DU"], subtasks: ["VOE processing", "Tax transcript review", "Self-employed analysis", "Rental income calc", "Trending income"] },
      ...
      { id: "eligibility", name: "Loan Program Eligibility Screening", desc: "Match borrower profile against available loan programs: Conventional, FHA, VA, USDA, Jumbo. Screen for credit score, DTI, LTV, and property eligibility requirements per program.", aiScore: 78, complexity: 5, frequency: "Daily", tools: ["DU", "LP", "GUS", "Encompass"], subtasks: ["Program matching", "Eligibility rules", "Guideline overlay check", "Product comparison"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "appraisal_review", name: "Appraisal Review & Reconciliation", desc: "Review full appraisal reports for compliance with USPAP standards, comparable selection quality, adjustments reasonableness, and condition/quality ratings. Flag inconsistencies with AVM or prior valuations.", aiScore: 55, complexity: 8, frequency: "Per Application", tools: ["Mercury", "UCDP", "EAD Portal", "CoreLogic"], subtasks: ["USPAP compliance check", "Comp selection review", "Adjustment analysis", "Condition assessment", "Reconsideration of value"] },
      { id: "title_search", name: "Title Search & Lien Check", desc: "Order and review title searches for clear ownership, existing liens, easements, and encumbrances. Identify issues requiring resolution before closing: subordination agreements, lien releases, boundary disputes.", aiScore: 75, complexity: 5, frequency: "Per Application", tools: ["SoftPro", "RamQuest", "First American", "Stewart Title"], subtasks: ["Title order", "Lien search", "Judgment review", "Exception clearing", "Title insurance commitment"] },
      { id: "flood_hazard", name: "Flood Zone & Hazard Determination", desc: "Determine property flood zone classification using FEMA flood maps. Identify special flood hazard areas requiring mandatory flood insurance. Assess other natural hazard risks per state requirements.", aiScore: 95, complexity: 2, frequency: "Per Application", tools: ["CoreLogic Flood", "ServiceLink", "FEMA NFIP", "Optimal Blue"], subtasks: ["Flood zone lookup", "LOMA review", "Insurance requirement", "Life-of-loan tracking"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "ltv_analysis", name: "Loan-to-Value Analysis", desc: "Calculate LTV, CLTV, and HCLTV ratios using appropriate property values. Determine PMI requirements, pricing adjustments, and eligibility for various programs based on LTV tiers.", aiScore: 88, complexity: 4, frequency: "Per Application", tools: ["Encompass", "DU", "LP", "PMI Rate Cards"], subtasks: ["Value determination", "LTV calculation", "PMI requirement", "LLPA pricing", "Subordinate lien analysis"] },
      { id: "conditional_approval", name: "Conditional Approval & Stipulations", desc: "Issue conditional loan approvals with specific conditions (prior-to-doc, prior-to-close, prior-to-fund). Track condition satisfaction, manage condition expiration, escalate outstanding items.", aiScore: 40, complexity: 8, frequency: "Per Application", tools: ["Encompass", "Workflow tools", "DocuSign"], subtasks: ["Condition list creation", "Priority classification", "Satisfaction review", "Expiration tracking", "Clear-to-close determination"] },
    ]
  },
  {
    id: "compliance_regulatory", name: "Compliance & Regulatory", icon: "\u25C7", color: "#FFB800",
    tasks: [
      { id: "fair_lending", name: "Fair Lending & Discrimination Testing", desc: "Perform fair lending analysis on approval/denial rates across protected classes. Monitor HMDA data quality, conduct regression analysis for pricing disparities, maintain fair lending risk assessments.", aiScore: 70, complexity: 8, frequency: "Quarterly", tools: ["ComplianceEase", "HMDA Tools", "Statistical packages", "Fair lending software"], subtasks: ["HMDA analysis", "Regression testing", "Denial rate review", "Pricing disparity", "Remediation planning"] },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "investor_delivery", name: "Investor Delivery & Whole Loan Trading", desc: "Package and deliver loans to GSEs or whole loan buyers. Manage best-execution analysis, mandatory vs. best-efforts delivery, pair-off calculations, and delivery tolerances.", aiScore: 58, complexity: 8, frequency: "Monthly", tools: ["Encompass", "Fannie Mae portal", "Freddie Mac portal", "Trading platforms"], subtasks: ["Best execution", "Pool creation", "Delivery scheduling", "Pair-off management", "Purchase advice reconciliation"] },
      { id: "loss_mitigation", name: "Loss Mitigation & Workout", desc: "Manage delinquent mortgage accounts: evaluate for forbearance, modification, short sale, or deed-in-lieu. Run NPV waterfall analysis, comply with CFPB servicing rules, maintain loss mitigation timelines.", aiScore: 50, complexity: 9, frequency: "Monthly", tools: ["Black Knight MSP", "LoanSphere", "Sagent", "CFPB tools"], subtasks: ["Delinquency triage", "Modification waterfall", "NPV analysis", "Forbearance plans", "CFPB compliance"] },
        ...
        <div style={{ padding: "0 20px 20px", fontSize: 13, color: t.textSecondary, lineHeight: 1.7 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <div>
              ...
              <p style={{ margin: 0 }}>This atlas maps <strong>every task</strong> performed by an experienced Mortgage Specialist. Tasks are organized into 6 domains, each as a radar chart showing AI automation potential (colored) vs complexity (white).</p>
    ...
    <div style={{ minHeight: "100vh", background: t.bg, color: t.text, fontFamily: "'DM Sans', sans-serif", transition: "background 0.4s, color 0.4s" }}>
      ...
      <div className="crm-app">
        ...
        <div style={{ background: t.headerBg, borderBottom: `1px solid ${t.border}`, padding: "28px 36px 22px" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap" as const, gap: 16, marginBottom: 20 }}>
            <div>
              ...
              <h1 style={{ margin: 0, fontSize: 30, fontWeight: 800, color: t.text, lineHeight: 1.2 }}>Mortgage Specialist</h1>
        ...
        <div style={{ marginTop: 40, padding: "20px 36px", background: t.footerBg, borderTop: `1px solid ${t.border}`, textAlign: "center" as const }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: t.textSecondary, marginBottom: 4 }}>Agentic AI Job Role Assessment Framework {"\u00B7"} Mortgage Specialist v1.0</div>
