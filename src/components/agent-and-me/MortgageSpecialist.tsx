...
function getDemoResults(): SimResults {
  return {
    ...
    scoring: {
      ...
      overallInsight: "AI adoption in mortgage underwriting is accelerating in document processing and compliance checks but remains constrained by exception-based decisioning and relationship-driven skills.",
        ...
        <div style={{ padding: "0 20px 20px", fontSize: 13, color: t.textSecondary, lineHeight: 1.7 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            <div>
              ...
              <p style={{ margin: 0 }}>This atlas maps <strong>every skill</strong> performed by an experienced Mortgage Specialist / Underwriter. Skills are organized into 6 domains, each as a radar chart showing AI automation potential (colored) vs complexity (white).</p>
