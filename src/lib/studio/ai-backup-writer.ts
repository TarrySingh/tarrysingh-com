...
- The AFFIRMATIVE couplet, which is the same move with the negation removed and is now the most common tell in this corpus (39 of 119 published posts). Shape: two consecutive short sentences that open on the same subject pronoun, where the second restates the first in worse terms to land a snap. Nothing is negated, so it evades the rule above. Write the claim once and spend the recovered words on evidence. Related and equally banned: three or more consecutive sentences opening on the same subject word; four or more consecutive sentences of eight words or fewer; a one-line paragraph under six words used as a drum-roll; a short setup, a colon, and a two-word payoff; and a question you ask only in order to answer it in the next sentence.
