...
export const PLATE_REGISTRY: ReadonlyArray<PlateRegistryEntry> = [
  ...
  {
    id: "comprehension-gap",
    displayName: "Comprehension Gap · Symphony",
    contentPath: "src/lib/synaptic/comprehension-gap-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony",
  },
  {
    id: "consortium-graph",
    displayName: "Consortium Graph · Symphony",
    contentPath: "src/lib/synaptic/consortium-graph-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony",
  },
  {
    id: "hominis-hero",
    displayName: "Hominis Hero · Symphony",
    contentPath: "src/lib/synaptic/hominis-hero-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony/tarry",
  },
  {
    id: "ramaswamy-cortex-hero",
    displayName: "Ramaswamy Cortex Hero · Symphony",
    contentPath: "src/lib/synaptic/ramaswamy-cortex-hero-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony/ramaswamy",
  },
  {
    id: "statistical-ceiling",
    displayName: "Statistical Ceiling · Symphony",
    contentPath: "src/lib/synaptic/statistical-ceiling-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony",
  },
  {
    id: "substrate-scales",
    displayName: "Substrate Scales · Symphony",
    contentPath: "src/lib/synaptic/substrate-scales-content.ts",
    slots: ["annotations", "captions"],
    group: "symphony",
    previewPath: "/synaptic/symphony",
  },
