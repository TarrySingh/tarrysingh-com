...
const experiments = [
  {
    ...
    description:
      "Live dashboard tracking an EU Horizon Europe consortium. 21 events, 143 progress reports, 7 work packages — visualized on an interactive timeline, a consortium map, a submission heatmap, and a WP activity lens.",
    to: "/experiments/panoraima",
    tag: "EU Horizon · Live data",
    tech: "Next.js, Python, Claude, Recharts, SVG",
    icon: Network,
