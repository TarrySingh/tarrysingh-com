...
const ROLES: JobRole[] = [
  ...
  { id: "commercial-credit-analyst", name: "Commercial Credit Analyst", tagline: "Corporate lending, financial spreads, covenants", icon: "🏢", taskCount: 31, avgScore: 67, status: "active", section: "credit_lending" },
